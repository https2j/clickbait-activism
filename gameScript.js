...
function draw() {
  if (GameOn === true) {
    ...
    if (line1_y < yPos_white + 15 && line1_y > yPos_white - 15) {
    ...
    if (line2_y < yPos_white + 15 && line2_y > yPos_white - 15) {
